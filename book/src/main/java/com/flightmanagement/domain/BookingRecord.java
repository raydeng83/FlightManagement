...
public class BookingRecord {
    ...
    public String toString() {
        return String.format("BookingRecord [id=%d, flightNumber=%s, from=%s, to=%s, flightDate=%s, bookingDate=%s, passengers=%s]", id, flightNumber, origin, destination, flightDate, bookingDate, passengers);
    }
}
